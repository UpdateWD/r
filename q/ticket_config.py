...
chat_worker_id = 1353097202 # ID Чата с воркерами

bot_name = 'workertir_bot' # Username Бота

mater = 'https://telegra.ph/Manual-LUXURY-CASINO-TEAM-12-29' # Ссылка на мануалы
zalet = 'https://telegra.ph/Manual-LUXURY-CASINO-TEAM-12-29' # Ссылка на канал с залётами
infos = 'https://telegra.ph/Manual-LUXURY-CASINO-TEAM-12-29' # Ссылка на инфо канал
pname = 'Сходил поссать' # Название проекта
pdate = '01012000' # Дата созданя проекта
